...
erDiagram
    ...
    DEFENSE_RESULTS }o--|| DEFENSE_SUMMARY : "defense × epsilon 집계"
    ...
    ATTACK_SAMPLES {
        ...
        INT steps
        NUMERIC threshold
        NUMERIC similarity_before
        NUMERIC similarity_after_attack
        NUMERIC similarity_gain
        BOOLEAN accepted_before
        BOOLEAN accepted_after_attack
        BOOLEAN attack_success_before_defense
        NUMERIC l2
        NUMERIC linf
        NUMERIC time_sec
        TEXT source_file
        TEXT target_enroll_file
        TEXT adv_file
        TEXT perturbation_file
    ...
    DEFENSE_RESULTS {
        ...
        VARCHAR defense
        JSONB defense_params
        NUMERIC similarity_after_attack
        NUMERIC similarity_after_defense
        BOOLEAN accepted_after_attack
        BOOLEAN accepted_after_defense
        BOOLEAN attack_success_after_defense
        BOOLEAN defense_success
        NUMERIC defense_time_sec
        TEXT adv_file
        TEXT defended_file
        TEXT target_enroll_file
        NUMERIC threshold
    ...
    ATTACK_SESSIONS {
        ...
        VARCHAR sample_id FK
        VARCHAR account_id
        NUMERIC threshold_margin
        BOOLEAN defense_bypassed
        NUMERIC risk_score
        VARCHAR risk_level
        TIMESTAMPTZ created_at
    }
    ...
    DEFENSE_SUMMARY {
        ...
        VARCHAR epsilon
        INT samples
        INT n_attack_success
        NUMERIC attack_success_rate
        INT n_defense_success
        NUMERIC defense_success_rate
        INT n_still_attack
        NUMERIC still_attack_rate
        NUMERIC avg_sim_after_attack
        NUMERIC avg_sim_after_defense
        NUMERIC avg_sim_drop
        NUMERIC avg_defense_time_sec
        TIMESTAMPTZ created_at
    }
```

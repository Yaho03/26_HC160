...
| Adversarial inspection | 독립 optional veto 2종으로 구현 | Transform-consistency(`adversarial`)와 template-shift(`adversarial_template`) 게이트, 공유 변환·임베딩, 정책 통합 test | 두 게이트의 clean calibration과 threshold artifact, adaptive attack, latency 평가 |
